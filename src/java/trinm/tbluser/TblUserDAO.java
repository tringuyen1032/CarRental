...
public class TblUserDAO implements Serializable {
    ...
    public boolean checkLogin(String ID) throws SQLException, NamingException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        boolean rt = false;
    ...
    public boolean createAccount(String ID, String password, String fullname, boolean role, String status) throws NamingException, SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        boolean rt = false;
        ...
        try {
            ...
            //2.    Create SQL String
            if (con != null) {
                String sql = "INSERT INTO tblUser(ID, name, pass, role, status) "
                        + "VALUES(?, ?, ?, ?, ?)";
                //3.    Create Statement Object
                stm = con.prepareStatement(sql);
                stm.setString(1, ID);
