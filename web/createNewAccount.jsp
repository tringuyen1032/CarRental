            ...
            <div class="login_form">
                <form action="createRecord" method="POST">
                    ...
                    <c:if test="${not empty errors.fullnameLengthErr}">
                        ...
                        <input type="text" name="txtPhone" class="txt_user" placeholder="Phone number*" value="${sessionScope.PHONESIGNUP}"/><br/>
                    <c:if test="${not empty errors.phoneLengthErr}">
                        <font class="txt_msg" color ="red">${errors.phoneLengthErr}</font>
                    </c:if>
                    <c:if test="${not empty errors.phoneTypeErr}">
                        <font class="txt_msg" color ="red">${errors.phoneTypeErr}</font>
                    </c:if>
                        <input type="text" name="txtAddress" class="txt_user" placeholder="Address*" value="${sessionScope.ADDRESSSIGNUP}"/><br/>
                    <c:if test="${not empty errors.addressLengthErr}">
                        <font class="txt_msg" color ="red">${errors.addressLengthErr}</font>
                    </c:if>
                    <div class="btn">
