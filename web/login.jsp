        ...
        <div class="form">
            <div class="login_form">
                <form action="login" method="POST">
                    ...
                    <a class="loginFace" href="https://www.facebook.com/dialog/oauth?client_id=184949363155666&redirect_uri=http://localhost:8084/CarRental/login&scope=email">Login Facebook</a>
                </form>
                <div class="display-2">
                    <div id="hr">
                ...
                <form action="createAccount">
                    ...
                    <a class="loginFace" href="https://www.facebook.com/dialog/oauth?client_id=184949363155666&redirect_uri=http://localhost:8084/CarRental/createRecord&scope=email">Create with Facebook</a>
                </form>
                <br>
            </div>
        </div>
